				...
				<div class="content-wrapper">
					...
					<div class="container-xxl">
						<h4 class="fw-bold py-3 mb-4">
							<span class="text-muted fw-light">MatDesign /</span> 會員查詢
						</h4>
						...
						<div
							...
							<div class="authentication-inner">
								...
								<div class="card">
									...
									<a href="listAllMember.jsp" class="card-header">會員列表</a>
									<div class="card-body">
										<form method="post" action="MemberServlet">
											<div class="row gx-3 gy-2 align-items-center">
												<div class="col-md-3">
													<label class="form-label" for="selectTypeOpt">輸入會員編號</label>
													<div class="col-sm-10">
														<input type="text" class="form-control"
															id="basic-default-name" name="memberNo" /> <input
												...
												<div class="col-md-3">
													...
													<button type="submit" id="showToastPlacement"
														class="btn btn-primary d-block">送出</button>
												</div>
											</div>
										</form>
										<br>
										...
										<form method="post" action="MemberServlet">
											<div class="row gx-3 gy-2 align-items-center">
												<div class="col-md-3">
													<label class="form-label" for="selectTypeOpt">選擇會員編號</label>
													<select id="selectTypeOpt"
														class="form-select color-dropdown" name="memberNo">
														<c:forEach var="memberVO" items="${memberSvc.all}">
															<option value="${memberVO.memberNo}">${memberVO.memberNo}
														</c:forEach>
													</select>
												</div>
												<div class="col-md-3">
										...
										<form method="post" action="MemberServlet">
											<div class="row gx-3 gy-2 align-items-center">
												<div class="col-md-3">
													<label class="form-label" for="selectTypeOpt">選擇會員名稱</label>
													<select id="selectTypeOpt"
														class="form-select color-dropdown" name="memberNo">
														<c:forEach var="memberVO" items="${memberSvc.all}">
															<option value="${memberVO.memberNo}">${memberVO.memberName}
														</c:forEach>
													</select>
												</div>
												<div class="col-md-3">
