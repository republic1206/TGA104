							...
							<div class="authentication-inner">
								...
								<div class="card ">
									<div class="card-body">
										...
										<h5 class="mb-2 card-title text-center">新增商品圖片</h5> 
...
<!-- 					of 800K</p> -->
		...
		<input type="hidden" name="action" value="addPic"> <input
			class="btn btn-primary d-grid w-100" type="submit"
			value="送出新增">
	</form>
	
	<a href="../../SelectAllPic">回商品圖片頁</a>
</div>
								</div>
								<!-- Register Card -->
							</div>
