...
<body>
	...
	<form id="#" class="mb-3"  METHOD="post" enctype="multipart/form-data" action="PicServlet" name="form1">
		<div class="mb-3">
			<label for="#" class="form-label">商品圖片編號:<font color=red><b>*</b></font></label> 			
...
<!-- 					of 800K</p> -->
		...
		<input
			...
			value="上傳" name="upload">
	</form>
<a href="SelectAllPic">回商品圖片列表</a>
