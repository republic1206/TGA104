				...
				<div class="content-wrapper">
					...
					<div class="container-xxl">
						<h4 class="fw-bold py-3 mb-4">
							<span class="text-muted fw-light">MatDesign /</span> 管理員查詢
						</h4>
						...
						<div
							...
							<div class="authentication-inner">
								...
								<div class="card">
									...
									<a href="listAllAdmin.jsp" class="card-header">管理員列表</a>
									<div class="card-body">
										<form method="post" action="admin.do">
											<div class="row gx-3 gy-2 align-items-center">
												<div class="col-md-3">
													<label class="form-label" for="selectTypeOpt">輸入管理員編號</label>
													<div class="col-sm-10">
														<input type="text" class="form-control"
															id="basic-default-name" name="adminNo" /> <input
										...
										<form method="post" action="admin.do">
											<div class="row gx-3 gy-2 align-items-center">
												<div class="col-md-3">
													<label class="form-label" for="selectTypeOpt">選擇管理員編號</label>
