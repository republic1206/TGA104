							...
							<div class="authentication-inner">
								...
								<div class="card ">
									<div class="card-body">
										...
										<h5 class="mb-2 card-title text-center">建立MatDesign管理員帳戶</h5>
										...
										<form id="formAuthentication" class="mb-3" action="admin.do"
											method="POST" name="addAdmin" enctype="multipart/form-data">
											<div class="mb-3">
												<label for="email" class="form-label">帳號(Email)</label> <input
													type="text" class="form-control" id="email"
													name="adminEmail" placeholder="Enter email" autofocus
													value="<%=(adminVO == null) ? "" : adminVO.getAdminEmail()%>" />
											</div>
											<div class="mb-3">
												<label for="username" class="form-label">管理員名稱</label> <input
													type="text" class="form-control" id="username"
													name="adminName" placeholder="Enter username"
													value="<%=(adminVO == null) ? "" : adminVO.getAdminName()%>" />
											</div>
											...
											<div class="mb-3">
												...
												<div class="button-wrapper">
													<label for="upload" class="btn btn-secondary" tabindex="0">
														...
														accept="image/png, image/jpeg" name="adminPic" <%=(adminVO == null) ? "" : adminVO.getAdminPic()%>"/>
													</label>
