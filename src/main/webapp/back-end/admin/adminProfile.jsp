				...
				<div class="content-wrapper">
					...
					<div class="container-xxl flex-grow-1 container-p-y">
						<h4 class="fw-bold py-3 mb-4">
							<span class="text-muted fw-light">MatDesign /</span> 管理員個人資料
						</h4>
									...
									<div class="row">
										<div class="mb-3 col-md-6">
											<label for="email" class="form-label">管理員E-mail</label> <input
												...
												name="adminEmail" value="<%=adminVO.getAdminEmail()%>" readonly/>
										</div>
										<!-- 排版用區塊  隱藏權限-->
										<div class="mb-3 col-md-6">
										...
										<div class="mb-3 col-md-6 ">
											...
											<div class="input-group input-group-merge">
												<input class="form-control" type="password" id="firstName"
													name="adminPassword"
													value="<%=adminVO.getAdminPassword()%>" readonly/> <!-- <span
										...
										<div class="mb-3 col-md-6">
											<label for="firstName" class="form-label">管理員名稱</label> <input
												...
												name="adminName" value="<%=adminVO.getAdminName()%>" readonly/>
										</div>
										<!-- 排版用區塊  -->
										<div class="mb-3 col-md-6"></div>
										<div class="mb-3 col-md-6">
