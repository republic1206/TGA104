...
public class MailService {
	...
	private final static String SENDER = "tga104g4@gmail.com";
	private final static String PASSWORD = "efguqrpwwvlvsejd";
...
//   		寄出email
	...
	public static void main(String args[]) {
		...
		String messageText = "<h2>Hello! " + ch_name + "</h2>" +"<br> <p> 請點擊以下連結確認信箱帳號無誤</p>" + 
				 "<a href='http://localhost:8081/TGA104_G4/front-end/Activation?memberNo=" + no +"'>確認</a><br>";
