...
@WebServlet("/OrderPhaseInfo")
public class OrderPhaseInfo extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			ResultSet rs = stmt.executeQuery("select orderPhaseAtt from DesignerOrderPhase where orderNO=" + orderNo);
